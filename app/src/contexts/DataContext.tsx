...
const mockProjects: Project[] = [
  {
    ...
    latitude: 16.3067,
    longitude: 80.4372,
    images: ['https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=max&w=2400&q=90&dpr=2'],
  ...
  },
  {
    ...
    latitude: 12.9716,
    longitude: 77.5946,
    images: ['https://images.unsplash.com/photo-1545208942-e0c45d2d07c7?auto=format&fit=max&w=2400&q=90&dpr=2'],
  ...
  },
  {
    ...
    latitude: 13.0827,
    longitude: 80.2707,
    images: ['https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?auto=format&fit=max&w=2400&q=90&dpr=2'],
